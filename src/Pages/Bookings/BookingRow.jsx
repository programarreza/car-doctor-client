...
const BookingRow = ({ booking, handleDelete, handleBookingConform }) => {
			...
			<tr>
				...
				<th>
					{ status === 'confirm' ? <span className="text-primary font-bold">Confirmed</span> :
						<button onClick={() => handleBookingConform(_id)} className="btn btn-ghost btn-xs">Please Confirm</button>
					}
				</th>
			</tr>
		</div>
