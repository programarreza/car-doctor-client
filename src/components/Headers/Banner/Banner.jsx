		...
		<div>
			<div className="carousel w-full">
				<div id="slide1" className="carousel-item relative w-full">
					...
					<div className="absolute rounded-xl flex items-center h-full left-0 right-0 bottom-0 bg-gradient-to-r from-[#151515] to-[#15151500]">
				...
				<div id="slide2" className="carousel-item relative w-full">
					...
					<div className="absolute rounded-xl flex justify-end bottom-0 transform -translate-y-1/2 left-5 right-5 ">
